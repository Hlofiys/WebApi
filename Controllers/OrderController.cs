    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<ActionResult<ServiceResponse<string>>> Register(OrderCreateDto request)
        {
            ...
            var response = await _orderService.Create(
                new Order { FIO = request.FIO, Address = request.Address, Contact = request.Contact, PhoneNubmer = request.PhoneNumber, Shipping = Shipping , ZipCode = request.ZipCode}, Request);
